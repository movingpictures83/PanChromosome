...
my $output_id;    #Default value for -n
...
$max_radius   = 400;                 #Radius of the chromosome image
$border       = 120;                 #Size of the border between chromosome and the edge of the screen
$layer_height = $max_radius / 12;    #
$gene_height  = 24;                  #height of the gene icons in the image
$tick_height  = $gene_height / 3;    # tick size on the edge of the image
$text_height  = 6;                   #Height of the
$thumb_dif    = 0.15;                #The proportional size of the thumbnail sketches
$DPI          = 2;                   #gives the DPI for outputed PNG images

$SVGHEIGHT = 2 * ( $border + $max_radius );    #Height of the total image
$SVGWIDTH  = 2 * ( $border + $max_radius );    #Width of the total image
$thumb_size_h = $SVGHEIGHT * $thumb_dif;                 # size of the thumbnails
$thumb_size_w = $SVGWIDTH * $thumb_dif;                  # size of thumbnails
$chng_w       = $gene_height + $thumb_size_w;            #
$disp         = "inline-block";                          #The
$bw           = ( $max_radius * 2 - 2.25 * $border );    #body width
$bodyTop      = "30px";                                  #Sets the location of the table body
$bodyHeight   = ( $max_radius / 4 - 30 ) . "px";         #height
$bodyWidth    = "100%";                                  #width of the table body


$disk_image_orig = disk_image("default");

#This is the image of the disk appropiate for javascript
$disk_image_js = disk_image("js");


$out_name    = "OUT";                                    #
$filenameSVG = $out_name . ".svg";                       #written svgs
$filenameTXT = $out_name . ".txt";                       #written txt files
$filenamePNG = $out_name . ".png";                       #written png files
$tree_size = 500;

$default_table      = "ButtonIDRegion";    #The starting table selection Javascript ID
$default_table_type = "Region"; 
$core_cnt   = 0;
$CORE_PERCT = 0.75;
$GENOME_NUM = 0;
...
sub output {
$file_in1 = PerlPluMA::prefix."/".$file_data{"input"};
$func_file = PerlPluMA::prefix."/".$file_data{"function"};
$tree_file = PerlPluMA::prefix."/".$file_data{"tree"};
$mult_align_dir = $file_data{"fasta"};
$out_dir = $_[0];

#perl make_panacea.pl -i example_dir/PanACEA.flatfile.txt -o example_dir/ -f example_dir/func_file.conf.txt -t example_dir/genome.tree -a example_dir/cluster_alignments/,example_dir/combined.fasta
